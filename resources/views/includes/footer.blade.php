                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-6 col-lg-3">
                                <div class="widget about_widget wow fadeIn" data-wow-delay="0.1s">
                                    <div class="logo"><h1 itemprop="headline"><a href="{{route('home')}}" title="Home" itemprop="url"><img src="{{asset('images/CapCaplogo.png')}}" alt="logo.png" itemprop="image" width="120"></a></h1></div>
                                    <p itemprop="description">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Neque, veniam eum quas totam eaque exercitationem nesciunt inventore aliquid praesentium laudantium quis. Nisi aliquam eos explicabo praesentium rerum reiciendis aliquid excepturi?</p>
                                    <div class="social2">
